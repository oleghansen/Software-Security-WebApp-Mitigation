...
class Sql
{
    ...
    static function up()
    {
        ...
        $q1 = "CREATE TABLE users (id INTEGER PRIMARY KEY, user VARCHAR(50), pass VARCHAR(60), email varchar(50) default null, fullname varchar(50), address varchar(70), postcode varchar (4), age varchar(50), bio varhar(250), isadmin INTEGER, isdoctor INTEGER default 0, bankcard varchar(12) default null, balance INTEGER DEFAULT 0);";
        $q6 = "CREATE TABLE posts (postId INTEGER PRIMARY KEY AUTOINCREMENT, author TEXT, title TEXT NOT NULL, content TEXT NOT NULL, date TEXT NOT NULL, doctor_Post INTEGER, doctor_Answered INTEGER, FOREIGN KEY(author) REFERENCES users(user));";
    ...
    static function insertPosts() {
        $q4 = "INSERT INTO posts(author, date, title, content, doctor_Post, doctor_Answered) VALUES ('bob', '26082015', 'I have a problem', 'I have a generic problem I think its embarrasing to talk about. Someone help?',0,0)";
        $q5 = "INSERT INTO posts(author, date, title, content, doctor_Post, doctor_Answered) VALUES ('bjarni', '26082015', 'I also have a problem', 'I generally fear very much for my health', 1, 0)";
