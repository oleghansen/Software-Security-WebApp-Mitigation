...
class Sql
{
    ...
    static function up()
    {
        $q1 = "CREATE TABLE users (id INTEGER PRIMARY KEY, user VARCHAR(50), pass VARCHAR(50), salt VARCHAR(50), email varchar(50) default null, fullname varchar(50), address varchar(50), postcode varchar (4), age varchar(50), bio varhar(50), isadmin INTEGER, chreditcard VARCHAR(50) DEFAULT null);";
    ...
    static function insertDummyUsers()
    {
        ...
        $hash1 = Hash::make("gruppe72015erbest", $salt1);
        $hash2 = Hash::make('bobdylan', $salt2);
        $hash3 = Hash::make('liverpool', $salt3);

        $q1 = "INSERT INTO users(user, pass, salt, isadmin, fullname, address, postcode) VALUES ('admin', '$hash1', '$salt1', 1, 'admin', 'homebase', '9090')";
        $q2 = "INSERT INTO users(user, pass, salt, isadmin, fullname, address, postcode) VALUES ('bob', '$hash2', '$salt2', 1, 'Robert Green', 'Greenland Grove 9', '2010')";
        $q3 = "INSERT INTO users(user, pass, salt, isadmin, fullname, address, postcode) VALUES ('bjarni', '$hash3', '$salt3', 1, 'Bjarni Torgmund', 'Hummerdale 12', '4120')";
