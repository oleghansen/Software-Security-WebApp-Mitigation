...
class Sql
{
    ...
    static function up()
    {
        $q1 = "CREATE TABLE users (id INTEGER PRIMARY KEY, user VARCHAR(50), pass VARCHAR(60), email varchar(50) default null, fullname varchar(50), address varchar(50), postcode varchar (4), age varchar(50), bio varhar(50), isadmin INTEGER, isdoctor INTEGER default 0, bankcard varchar(12) default null);";
    ...
    static function insertDummyUsers()
    {
        ...
        $q1 = "INSERT INTO users(user, pass, isadmin, fullname, address, postcode, isdoctor) VALUES ('admin', '$hash2', 1, 'admin', 'homebase', '9090', 1)";
        ...
        $q3 = "INSERT INTO users(user, pass, isadmin, fullname, address, postcode) VALUES ('bjarni', '$hash2', 1, 'Bjarni Torgmund', 'Hummerdale 12', '4120')";
